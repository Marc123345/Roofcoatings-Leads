      ...
      <main className="bg-navy min-h-screen">
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white uppercase tracking-tighter leading-tight mb-6">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-8">
            ...
            <h2 className="text-2xl font-black text-white uppercase tracking-tighter mt-12 border-t border-zinc-800 pt-8">
            ...
            <div className="bg-navy-light border border-zinc-800 rounded-sm p-6 space-y-3">
              <div className="flex items-start gap-3">
                <span className="text-gold font-mono text-sm font-bold">01</span>
                <p className="text-white text-sm"><strong>Problem:</strong> aging roof, leaks, ponding water, rising repair costs.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gold font-mono text-sm font-bold">02</span>
                <p className="text-white text-sm"><strong>Solution:</strong> roof coating can extend roof life and help prevent further damage.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gold font-mono text-sm font-bold">03</span>
                <p className="text-white text-sm"><strong>Offer:</strong> free inspection, estimate, or consultation.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-gold font-mono text-sm font-bold">04</span>
                <p className="text-white text-sm"><strong>CTA:</strong> book now, get a quote, request your assessment.</p>
              </div>
            </div>
            ...
            {/* CTA */}
            <div className="mt-16 bg-navy-light border border-zinc-800 rounded-sm p-8 sm:p-12 text-center">
              ...
              <p className="text-zinc-600 text-xs mt-4 font-mono tracking-wider uppercase">
