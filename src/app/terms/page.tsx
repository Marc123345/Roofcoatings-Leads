    ...
    <>
      ...
      <main className="bg-navy min-h-screen">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-8">Terms of Service</h1>
          <div className="prose prose-invert prose-sm max-w-none text-white space-y-6">
            ...
            <p>Our lead generation service is priced at $1,500 per month. This includes all campaign management, lead qualification, AI chatbot booking, and dedicated campaign management. Pricing is subject to change with 30 days notice.</p>
