...
export default function Scalability() {
  ...
  return (
    <section className="bg-navy py-16 sm:py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 hidden sm:block w-[200px] h-[200px] lg:w-[500px] lg:h-[500px] bg-gold/5 rounded-sm blur-[100px]" />
      <div className="absolute bottom-0 left-0 hidden sm:block w-[200px] h-[200px] lg:w-[400px] lg:h-[400px] bg-blue/5 rounded-sm blur-[80px]" />
            ...
            <div className="lg:col-span-3 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  ...
                  initial={{ opacity: 0.5 }} animate={{ opacity: 1 }}
                  className="bg-gold/10 rounded-sm border border-gold/20 p-6 text-center"
                >
