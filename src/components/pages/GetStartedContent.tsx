            ...
            <div className="grid lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
                ...
                <AnimateIn delay={0.2}>
                  <div className="bg-navy-light rounded-2xl border border-white/5 p-5">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 bg-gold/20 rounded-full flex items-center justify-center text-gold font-bold text-sm">M</div>
                      <div>
              ...
              <div className="lg:col-span-3">
                <AnimateIn delay={0.15}>
                  <div className="bg-navy-light rounded-3xl border border-white/10 overflow-hidden">
