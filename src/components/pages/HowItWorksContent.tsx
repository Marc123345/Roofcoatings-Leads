...
const steps = [
  ...
  },
  {
    ...
    short: "Your lead. Only you. Instantly.",
    description: "When a lead passes qualification, it goes directly to you — and only to you — in real time. You get an instant notification with their name, contact details, property type, and qualification answers. Speed-to-lead is everything.",
