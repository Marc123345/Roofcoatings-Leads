  ...
  return (
    <>
        ...
        <motion.div className="relative z-10 py-32 lg:py-44 text-center" style={{ opacity: heroOpacity }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div className="mt-10 flex justify-center gap-3 flex-wrap"
              ...
              {serviceAreas.map((sa) => (
                <div key={sa.slug} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
        ...
        <div className="relative z-10 py-24 lg:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <AnimateIn><h2 className="text-3xl sm:text-4xl font-bold text-white">Explore Our Markets</h2></AnimateIn>
            ...
            <AnimatePresence mode="wait">
              <motion.div key={area.slug}
                ...
                <div className="grid lg:grid-cols-5 gap-6">
                  {/* Map panel */}
                  <div className="lg:col-span-2 bg-navy-light rounded-3xl border border-white/10 p-6 flex flex-col">
                  ...
                  <div className="lg:col-span-3 flex flex-col gap-6">
                    ...
                    <div className="bg-navy-light rounded-2xl border border-white/10 p-6">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-12 h-12 bg-gold/20 rounded-full flex items-center justify-center text-gold font-bold shrink-0">
      ...
      <section className="bg-gray-light py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <AnimateIn><h2 className="text-3xl sm:text-4xl font-bold text-navy">All Active Markets</h2></AnimateIn>
          </div>
              ...
              <StaggerItem key={sa.slug}>
                <motion.a href={`/service-areas/${sa.slug}`}
                  ...
                  <div className="relative h-44 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-gold text-navy text-xs font-bold px-3 py-1 rounded-full">{sa.abbr}</div>
      ...
      <section className="bg-navy py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <AnimateIn><h2 className="text-3xl sm:text-4xl font-bold text-white">We Cover All 50 States</h2></AnimateIn>
