...
const winLogs = [
  ...
  },
  {
    ...
    before: { cpl: "$118", source: "HomeAdvisor", closeRate: "11%", costPerJob: "$1,073" },
  ...
  },
  {
    ...
    quote: "Best investment this year. Cost per acquisition is significantly lower than other platforms — and California leads close at premium rates because of Title 24.",
    before: { cpl: "$165", source: "HomeAdvisor", closeRate: "7%", costPerJob: "$2,357" },
