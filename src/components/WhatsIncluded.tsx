            ...
            <div className="lg:col-span-7">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="bg-navy rounded-3xl p-6 sm:p-8 lg:p-10 h-full flex flex-col"
                >
                  ...
                  <div className="mt-8 flex items-center gap-3 bg-white/[0.04] rounded-xl p-4 border border-white/[0.06]">
        ...
        <div className="mt-16 sm:mt-20">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto" staggerDelay={0.1}>
            ...
            <StaggerItem className="md:col-span-1">
              <motion.div
                className="bg-navy rounded-3xl p-6 sm:p-8 text-center relative overflow-hidden h-full flex flex-col"
                whileHover={{ y: -4 }}
              >
            ...
            {addOns.map((addon) => (
              <StaggerItem key={addon.title}>
                <motion.div
                  className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-light/80 text-center h-full flex flex-col"
                  whileHover={{ y: -4, borderColor: "rgba(37,99,235,0.2)", boxShadow: "0 12px 40px rgba(0,0,0,0.06)" }}
                >
                  <div className="w-14 h-14 bg-navy/5 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    {addon.icon}
                  </div>
