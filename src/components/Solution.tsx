    ...
    <section className="bg-navy py-16 sm:py-20 lg:py-32 relative overflow-hidden noise">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <AnimateIn delay={0.1}>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black text-white leading-tight uppercase tracking-tighter max-w-3xl mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6" staggerDelay={0.1}>
          ...
          <StaggerItem className="md:col-span-7 md:row-span-2">
            <motion.div
              className="glass rounded-sm p-5 sm:p-8 h-full flex flex-col justify-between group"
              whileHover={{ borderColor: "rgba(37,99,235,0.3)" }}
            >
              <div>
                <div className="w-12 h-12 bg-gradient-to-br from-blue to-blue-light rounded-sm flex items-center justify-center mb-4 shadow-lg">
                ...
                <p className="text-white mt-2 max-w-md text-sm leading-relaxed">
          ...
          <StaggerItem className="md:col-span-5">
            <motion.div
              className="glass rounded-sm p-6 h-full group"
              whileHover={{ scale: 1.02, borderColor: "rgba(37,99,235,0.3)" }}
              transition={{ duration: 0.2 }}
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-blue to-blue-light rounded-sm flex items-center justify-center shrink-0 shadow-lg">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-white text-sm leading-relaxed mt-1">Target facility managers and building owners with aging roofs</p>
                </div>
              </div>
          ...
          <StaggerItem className="md:col-span-5">
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-gold to-yellow-500 rounded-sm flex items-center justify-center shrink-0 shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-white text-sm leading-relaxed mt-1">Connect with residential flat roof owners experiencing issues</p>
                </div>
              </div>
