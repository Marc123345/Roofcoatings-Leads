      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6" staggerDelay={0.1}>
          ...
          <StaggerItem className="md:col-span-7 md:row-span-2">
            <motion.div
              className="glass rounded-none p-5 sm:p-8 h-full flex flex-col justify-between group"
              whileHover={{ borderColor: "rgba(37,99,235,0.3)" }}
            >
              <div>
                <div className="w-12 h-12 bg-gradient-to-br from-blue to-blue-light rounded-none flex items-center justify-center mb-4 shadow-lg">
          ...
          <StaggerItem className="md:col-span-5">
            <motion.div
              className="glass rounded-none p-6 h-full group"
              whileHover={{ scale: 1.02, borderColor: "rgba(37,99,235,0.3)" }}
              transition={{ duration: 0.2 }}
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-blue to-blue-light rounded-none flex items-center justify-center shrink-0 shadow-lg">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <StaggerItem className="md:col-span-5">
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-gold to-yellow-500 rounded-none flex items-center justify-center shrink-0 shadow-lg">
