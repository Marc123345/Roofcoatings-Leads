...
const REVIEWS: Review[] = [
  ...
  { name: "Brian M.", company: "Heritage Coat Co.", state: "TN", text: "Went from spending $4K/month on dead leads to $1K/month on leads that actually close. Do the math." },
  ...
  { name: "Stephanie M.", company: "Sunbelt Roof Systems", state: "AL", text: "Small town contractor, big results. $1K/month and I'm booked out 6 weeks. Can't ask for more.", stat: "6 weeks", statLabel: "booked out" },
