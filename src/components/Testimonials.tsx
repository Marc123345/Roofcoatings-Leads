    ...
    <div ref={containerRef} id="testimonials" className="relative h-[150vh] sm:h-[200vh] lg:h-[300vh] bg-navy">
      <div className="sticky top-0 h-[100dvh] flex flex-col justify-center overflow-hidden border-t border-zinc-800 pt-14 pb-2 sm:pt-16 sm:pb-4 lg:pt-20 lg:pb-0">
        ...
        <div className="text-center mb-6 lg:mb-10 px-4">
          <div className="font-mono text-[10px] tracking-[0.2em] uppercase mb-4">
              ...
              <AnimatePresence custom={directionRef.current} mode="popLayout">
                ...
                >
                  <div className="flex flex-col gap-5">
                    ...
                    {/* Quote */}
                    <blockquote className="text-base sm:text-lg lg:text-2xl font-medium leading-relaxed text-white/90 ">
                      &ldquo;{partner.quote}&rdquo;
                    </blockquote>

                    {/* Stat highlight */}
                    <div className="flex items-center gap-3 bg-gold/10 border border-gold/20 rounded-sm px-5 py-3 self-start">
              ...
              <div className="hidden lg:flex overflow-x-auto gap-2 px-4 py-3" style={{ scrollbarWidth: "none" }}>
                {PARTNERS.map((p, i) => (
                  <button
                    ...
                    className="flex items-center shrink-0 gap-2 px-4 py-2 transition-all duration-200 rounded-sm"
                    style={{
