      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-4 sm:gap-6 lg:gap-8">
            ...
            <motion.a
              href="/get-started"
              className="relative bg-gradient-to-r from-gold to-yellow-400 text-navy px-6 py-2.5 rounded-xl font-bold text-sm overflow-hidden group shadow-lg shadow-gold/20"
          ...
          {mobileOpen && (
            ...
            >
              <div className="pb-6 flex flex-col gap-3">
                ...
                <a
                  href="/get-started"
                  className="bg-gradient-to-r from-gold to-yellow-400 text-navy px-5 py-2.5 rounded-xl font-bold text-sm text-center"
                  onClick={() => setMobileOpen(false)}
                >
                  Talk to Marc &rarr;
                </a>
