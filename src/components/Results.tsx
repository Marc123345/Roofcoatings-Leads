...
export default function Results() {
  return (
    <section id="results" className="bg-navy py-16 sm:py-20 lg:py-32 relative overflow-hidden noise">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden sm:block w-[250px] h-[250px] lg:w-[600px] lg:h-[600px] bg-gold/5 rounded-none blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <StaggerContainer className="mt-14 grid grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-6" staggerDelay={0.1}>
          ...
          <StaggerItem className="lg:col-span-3">
            <motion.div
              className="glass rounded-none p-6 h-full text-center border-t-2 border-gold/40 shimmer"
          ...
          <StaggerItem className="col-span-2 lg:col-span-6 row-span-2">
            <motion.div
              className="glass rounded-none p-4 sm:p-6 h-full flex flex-col justify-center"
        ...
        <AnimateIn delay={0.5}>
          <div className="mt-12 text-center">
            <motion.a
              href="#cta"
              className="inline-block bg-gradient-to-r from-blue to-blue-light text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-none font-semibold text-base sm:text-lg w-full sm:w-auto text-center overflow-hidden relative group"
