...
export default function Hero() {
  return (
    <>
      ...
      {/* ── Stats strip — large numbers like Figma's 390/130/480 pattern ── */}
      <section className="bg-navy border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/[0.04] overflow-hidden"
          ...
          >
            {stats.map((stat) => (
              <div key={stat.label} className="bg-navy px-6 py-8 sm:py-12 text-center sm:text-right">
                <div className="text-gold/40 flex justify-center sm:justify-end mb-2">{stat.icon}</div>
                <p className="text-white font-extrabold text-3xl sm:text-4xl lg:text-5xl tracking-tight">
                  {stat.value}
                </p>
