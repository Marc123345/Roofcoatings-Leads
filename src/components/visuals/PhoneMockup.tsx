      ...
      <div className="bg-navy-light rounded-[2rem] border-2 border-white/10 p-2 shadow-2xl">
        ...
        <div className="bg-navy rounded-[1.5rem] overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 pt-3 pb-1">
            <span className="text-white/80 text-[9px]">9:41</span>
          ...
          <div className="px-4 pb-4 space-y-3 pt-2">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-white text-[10px] font-bold">New Lead Alert</span>
              ...
              <div className="flex gap-2 mt-2">
                <div className="bg-blue text-white text-[9px] px-3 py-1 rounded-full font-medium">Call Now</div>
                <div className="bg-white/10 text-white/70 text-[9px] px-3 py-1 rounded-full">Details</div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-white text-[10px] font-bold">Lead Booked!</span>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-white text-[10px] font-bold">Weekly Summary</span>
              </div>
              <p className="text-white/70 text-[10px]">18 leads | 6 booked | $38 avg CPA</p>
            </motion.div>
          </div>
        </div>
      </div>
