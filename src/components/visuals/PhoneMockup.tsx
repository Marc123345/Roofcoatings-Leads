        ...
        <div className="bg-navy rounded-[1.5rem] overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 pt-3 pb-1">
            ...
            <div className="flex gap-1">
              <div className="w-3 h-1.5 bg-white/40 rounded-none" />
          ...
          <div className="px-4 pb-4 space-y-3 pt-2">
            <motion.div
              className="bg-gradient-to-r from-blue/20 to-blue/10 border border-blue/20 rounded-none p-3"
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-blue rounded-none flex items-center justify-center">
              ...
              <div className="flex gap-2 mt-2">
                <div className="bg-blue text-white text-[11px] px-3 py-1 rounded-none font-medium">Call Now</div>
                <div className="bg-white/10 text-white/70 text-[11px] px-3 py-1 rounded-none">Details</div>
              </div>
            </motion.div>

            <motion.div
              className="bg-white/5 border border-white/5 rounded-none p-3"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-green-500 rounded-none flex items-center justify-center">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                <div className="w-6 h-6 bg-gold rounded-none flex items-center justify-center">
