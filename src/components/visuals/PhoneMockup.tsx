          ...
          <div className="px-4 pb-4 space-y-3 pt-2">
            ...
            >
              ...
              <div className="flex gap-2 mt-2">
                <div className="bg-blue text-white text-[11px] px-3 py-1 rounded-full font-medium">Call Now</div>
                <div className="bg-white/10 text-white/70 text-[11px] px-3 py-1 rounded-full">Details</div>
              </div>
            </motion.div>
