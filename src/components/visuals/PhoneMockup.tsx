      ...
      <div className="bg-navy-light rounded-[2rem] border-2 border-zinc-800 p-2 border border-zinc-800">
        ...
        <div className="bg-navy rounded-[1.5rem] overflow-hidden">
          ...
          <div className="px-4 pb-4 space-y-3 pt-2">
            <motion.div
              className="bg-gradient-to-r from-blue/20 to-blue/10 border border-blue/20 rounded-sm p-3"
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-gold/50 rounded-sm flex items-center justify-center">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
