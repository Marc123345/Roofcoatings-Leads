...
export default function AdCreativeMockup({ variant = 1 }: { variant?: number }) {
  if (variant === 1) {
    return (
      <motion.div
        className="bg-white rounded-sm overflow-hidden shadow-lg w-full max-w-[280px]"
        whileHover={{ y: -4, scale: 1.02 }}
        transition={{ duration: 0.25 }}
      >
        {/* Ad header */}
        <div className="flex items-center gap-2 px-3 py-2">
          <div className="w-8 h-8 bg-blue rounded-sm flex items-center justify-center text-white text-[8px] font-bold leading-none">
        ...
        <div className="bg-gradient-to-br from-blue to-navy aspect-[4/3] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="text-center relative z-10 p-4">
            ...
            <div className="mt-3 bg-gold text-navy text-[11px] font-bold px-4 py-1.5 rounded-sm inline-block">
              Get Free Quote
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-br from-navy to-navy-light aspect-[4/3] flex items-center justify-center relative overflow-hidden">
        <div className="absolute top-4 right-4 w-16 h-16 bg-gold/20 rounded-sm blur-xl" />
        <div className="text-center relative z-10 p-4">
          ...
          <div className="mt-3 bg-blue text-white text-[11px] font-bold px-4 py-1.5 rounded-sm inline-block">
            Learn More
          </div>
        </div>
      </div>
