      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-4">
            ...
            <div className="space-y-3">
              <a href="mailto:marcfriedmancm@roofcoatleads.com" className="flex items-center gap-3 text-white/70 hover:text-gold transition-colors group">
                <div className="w-9 h-9 bg-white/5 rounded-none flex items-center justify-center group-hover:bg-gold/10 transition-colors shrink-0">
          ...
          <div className="lg:col-span-2">
            ...
            <a href="/get-started"
              className="inline-flex items-center bg-gradient-to-r from-gold to-yellow-400 text-navy px-5 py-2.5 rounded-none font-bold text-sm shadow-lg shadow-gold/10 hover:shadow-gold/20 transition-shadow">
              Talk to Marc &rarr;
            </a>
          </div>
        </div>
