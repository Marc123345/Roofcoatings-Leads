        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-4">
            ...
            <div className="space-y-3">
              <a href="mailto:marcfriedmancm@roofcoatleads.com" className="flex items-center gap-3 text-navy/70 hover:text-gold transition-colors group">
                <div className="w-9 h-9 bg-gray-100 rounded-sm flex items-center justify-center group-hover:bg-gold/10 transition-colors shrink-0">
              ...
              <a href="/get-started" className="flex items-center gap-3 text-navy/70 hover:text-gold transition-colors group">
                <div className="w-9 h-9 bg-gray-100 rounded-sm flex items-center justify-center group-hover:bg-gold/10 transition-colors shrink-0">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {footerLinks.map((col) => (
            <div key={col.title} className="lg:col-span-2">
              <h3 className="text-navy font-bold text-sm uppercase tracking-wider mb-4">{col.title}</h3>
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-navy/70 hover:text-gold text-sm transition-colors">
                      {link.label}
                    </a>
                  </li>
                ))}
          ...
          <div className="lg:col-span-2">
            <h3 className="text-navy font-bold text-sm uppercase tracking-wider mb-4">Get Started</h3>
            <p className="text-navy/70 text-sm mb-4">Proven lead system for your roof coating business.</p>
            <a href="/get-started"
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <a href="/privacy" className="text-navy/70 hover:text-gold text-xs transition-colors">Privacy</a>
            <a href="/terms" className="text-navy/70 hover:text-gold text-xs transition-colors">Terms</a>
          </div>
          <div className="flex items-center gap-4">
            <a href="/sitemap.xml" className="text-navy/70 hover:text-gold text-xs transition-colors">Sitemap</a>
            <span className="text-gray-300">|</span>
